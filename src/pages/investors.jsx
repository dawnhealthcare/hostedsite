          ...
          <Container>
            <Row>
              <Col md={12}>
                ...
                >
                  What COVID did, is it really pulled back the curtain on just
                  how severe the mental health epidemic is in the United States,
                  particularly among youth. There are three numbers that always
                  stick in my head. One, is the number 11, that’s the number of
                  years it takes on average for a child to receive treatment
                  after developing symptoms. The second number is, 57, that’s
                  the percentage increase in the suicide rate we had among kids
                  in the decade prior to the pandemic… The other number… is 44
                  percent. That’s the percentage of high school students who say
                  they feel persistently sad or hopeless… These to me stick in
                  my head because they give me a snapshot of where we are. We've
                  got to invest in prevention, especially school-based
            ...
            <Row>
              <Col md={12}>
                ...
                >
                  ...
                  With this renewed focus on adolescent mental health, we have
                  an opportunity to make a positive impact on the lives of
                  countless young people and help them to reach their full
                  potential. Let's join forces and prioritize the mental health
                  of our youth today for a brighter tomorrow.
                </SectionHeader>
              </Col>
              <Col md={12}>
                <div className="wow animate__animated animate__zoomIn">
        ...
        <SectionWrapper className="pb-5">
          <Container>
            ...
            <Row className="align-items-center">
              <Col lg={6}>
                <Para>
                  As an investor, you have the chance to be part of something
                  big and innovative. Our focus on primary and secondary
                  prevention means we're not just treating mental health issues
                  but also working to prevent them from happening in the first
                  place.
                </Para>
                <Para>
                ...
                <Para>
                  ...
                  approach our investor page, you're greeted by a colorful map
                  of destinations, each representing a different level of
                  investment.
                </Para>
                <Para>
                ...
                <Para>
                  For those seeking to make a significant impact, our
                  "Innovative Partnership" level provides exclusive access to
                  our most advanced research and initiatives, with the potential
                  for substantial financial returns.
                </Para>
                <Para>
                  No matter which level you choose, you can be assured that your
                  investment is helping to create a brighter future for
                  adolescents and their families. Join us on this journey to
                  make a difference in mental health, one investment at a time.
                </Para>
              </Col>
              <Col
                lg={6}
